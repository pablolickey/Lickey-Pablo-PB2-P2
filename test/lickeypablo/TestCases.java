...
public class TestCases {
	...
	public void queSeAgregueUnGol() throws NoEsJugador, JugadorNoEncontradoException {
		String nombreDelTorneo="copaAmerica";
		Torneo torneo= new Torneo(nombreDelTorneo);
		...
		Double min=31.1;
		Gol primerGol= new Gol(jugador1,min,idDelPartido,"07/07/2021 17:41");
		Integrante goleador1= torneo.buscarJugador(jugador1,idDelPartido);
		ArgentinaVsColombia.agregarGolLocal(torneo.agregarGol(primerGol,ArgentinaVsColombia,goleador1));
		
		Double min2=45.2;
		Gol segundoGol= new Gol(jugador4,min2, idDelPartido,"07/07/2021 17:42");
		Integrante goleador2= torneo.buscarJugador(jugador4,idDelPartido);
		ArgentinaVsColombia.agregarGolVisitante(torneo.agregarGol(segundoGol, ArgentinaVsColombia, goleador2));
		
		Double min3=48.0;
		Gol tercerGol= new Gol(jugador1,min3,idDelPartido,"07/07/2021 17:43");
		Integrante goleador3= torneo.buscarJugador(jugador1,idDelPartido);
		ArgentinaVsColombia.agregarGolLocal(torneo.agregarGol(tercerGol,ArgentinaVsColombia,goleador3));
		
		Double min4=50.0;
		Gol cuartoGol= new Gol(dt,min4,idDelPartido,"07/07/2021 17:44");
		Integrante elquemetegol=torneo.buscarJugador(dt,idDelPartido);
		ArgentinaVsColombia.agregarGolLocal(torneo.agregarGol(cuartoGol,ArgentinaVsColombia,elquemetegol));
		
		
		assertEquals((Integer)3,torneo.cantidadDeGoles());
	}
	...
	@Test 
	public void queMeOrdeneLosGoles() throws NoEsJugador, JugadorNoEncontradoException {
		String nombreDelTorneo="copaAmerica";
		Torneo torneo= new Torneo(nombreDelTorneo);
		...
		assertEquals(primerGol,torneo.mostrarGoles().first());
	}
